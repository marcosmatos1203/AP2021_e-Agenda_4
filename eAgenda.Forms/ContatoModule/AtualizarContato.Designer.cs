...
namespace eAgenda.Forms.ContatoModule
{
    partial class AtualizarContato
    {
        ...
        private void InitializeComponent()
        {
            ...
            // gbxLista
            // 
            this.gbxLista.Controls.Add(this.label5);
            this.gbxLista.Controls.Add(this.txtEmpresa);
            this.gbxLista.Controls.Add(this.label3);
            this.gbxLista.Controls.Add(this.txtCargo);
            this.gbxLista.Controls.Add(this.label4);
            this.gbxLista.Controls.Add(this.txtTelefone);
            this.gbxLista.Controls.Add(this.label2);
            this.gbxLista.Controls.Add(this.txtEmail);
            ...
            this.gbxLista.Text = "Dados do Contato";
            // 
            // label5
            // 

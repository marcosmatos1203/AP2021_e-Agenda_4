...
namespace eAgenda.Controladores.Shared
{
    ...
    public static class Db
    {
        ...
        //public static string nomeDoBanco = "SqlServer";
        static Db()
        {
            //EscolheDataBase(nomeDoBanco);
        ...
        //public static void EscolheDataBase(string dbUsado)
        //{
        //    try
        //    {
        ...
        //        if (dbUsado== "SQLite")
        //        {
        //            settings["bancoDeDados"].Value = "SQLite";
        //        }
        //        else if(dbUsado == "SqlServer")
        //        {
        //            settings["bancoDeDados"].Value = "SqlServer";
        //        }
